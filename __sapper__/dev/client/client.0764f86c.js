...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(main, file, 16, 0, 179);
		},
...
/* src/node_modules/@sapper/internal/error.svelte generated by Svelte v3.22.3 */

const { Error: Error_1 } = globals;
const file$1 = "src/node_modules/@sapper/internal/error.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file$1, 10, 1, 141);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$1, 5, 0, 59);
			add_location(p, file$1, 7, 0, 78);
		},
		m: function mount(target, anchor) {
